document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!isValid) {
        ...
        if (firstError) {
          firstError.focus();
          const offsetTop = firstError.getBoundingClientRect().top + window.pageYOffset - 100;
  ...
  const animatedEls = document.querySelectorAll('.fade-in, .scroll-animate, [data-animate]');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Summit Beast משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e5756f88-2dc7-4a78-84b0-6c7b4334ba48',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e5756f88-2dc7-4a78-84b0-6c7b4334ba48';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e5756f88-2dc7-4a78-84b0-6c7b4334ba48';
